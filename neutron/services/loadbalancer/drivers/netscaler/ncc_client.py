...
class NSClient(object):
    ...
    def _resource_operation(self, method, tenant_id, resource_path,
        ...
        resource_uri = self.service_uri + "/" + resource_path
