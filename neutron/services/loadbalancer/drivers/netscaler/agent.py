...
from neutron.services.loadbalancer.drivers.netscaler import agent_service
...
def main():
    ...
    lbaas_agent_service = agent_service.serve_wsgi(agent_service.LBaaSAgentApiService)
    service.launch(svc).wait()
    lbaas_agent_service.wait()
